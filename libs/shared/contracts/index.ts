...
export const ChannelSchema = z.templateLiteral([entities, ":", crudActions]);
export const PushEventSchema = z.enum(["i18n:update"]);
...
export type ChannelArg<T extends keyof typeof channelArgs> =
	(typeof channelArgs)[T] extends z.ZodType
		? z.input<(typeof channelArgs)[T]>
		: never;
export type ChannelResponse<T extends keyof typeof channelResponses> =
	(typeof channelResponses)[T] extends z.ZodType
		? z.output<(typeof channelResponses)[T]>
		: (typeof channelResponses)[T] extends {}
			? void
			: void;
