...
export type Channel = z.output<typeof ChannelSchema> | 'field-mapping:clear' | 'submission-sub-data:update' | 'submission-data:update' | 'resource:read' | 'theme:update' | 'index-suggestions:read' | 'submission-ref:read' | 'suggestions:read' | 'db:test' | 'translations:read' | 'options:read' | 'columns:read' | 'submission-data:read';
