 ...
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 * @returns {FormItemField | FormItemGroup | FormItemNote | FormItemSeparator}
 */
// @ts-ignore
 ...
 */
// @ts-ignore
export function createRelevanceLogicExpression_valueFromDiscriminatorValue(parseNode: ParseNode | undefined) : boolean | number | string | undefined {
    return parseNode?.getBooleanValue() ?? parseNode?.getNumberValue() ?? parseNode?.getStringValue();
}
/**
 * Creates a new instance of the appropriate class based on discriminator value
 * @param parseNode The parse node to use to read the discriminator value and create the object
 ...
 */
// @ts-ignore
export function deserializeIntoFormItemDefinition(formItemDefinition: Partial<FormItemField | FormItemGroup | FormItemNote | FormItemSeparator> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
...
export function deserializeIntoFormItemGroup(formItemGroup: Partial<FormItemGroup> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "children": n => { formItemGroup.children = n.getCollectionOfObjectValues<FormItemField>(createFormItemFieldFromDiscriminatorValue) ?? n.getCollectionOfObjectValues<FormItemGroup>(createFormItemGroupFromDiscriminatorValue) ?? n.getCollectionOfObjectValues<FormItemNote>(createFormItemNoteFromDiscriminatorValue) ?? n.getCollectionOfObjectValues<FormItemSeparator>(createFormItemSeparatorFromDiscriminatorValue); },
...
export function deserializeIntoRelevanceLogicExpression(relevanceLogicExpression: Partial<RelevanceLogicExpression> | undefined = {}) : Record<string, (node: ParseNode) => void> {
    return {
        ...
        "operator": n => { relevanceLogicExpression.operator = n.getEnumValue<RelevanceLogicExpression_operator>(RelevanceLogicExpression_operatorObject); },
        "value": n => { relevanceLogicExpression.value = n.getBooleanValue() ?? n.getNumberValue() ?? n.getStringValue(); },
    }
}
/**
 * The deserialization information for the current model
...
export type FormItemDefinition = FormItemField | FormItemGroup | FormItemNote | FormItemSeparator;
...
export interface FormItemGroup extends BaseFormItemDefinition, Parsable {
     ...
     */
    children?: (FormItemField | FormItemGroup | FormItemNote | FormItemSeparator)[] | null;
    /**
     * The type property
     */
...
export interface FormVersionDefinition extends Parsable {
     ...
     * The items property
     */
    items?: (FormItemField | FormItemGroup | FormItemNote | FormItemSeparator)[] | null;
    /**
     * The parentId property
     */
    parentId?: Guid | null;
...
export interface RelevanceLogicExpression extends Parsable {
     ...
     * The operator property
     */
    operator?: RelevanceLogicExpression_operator | null;
    /**
     * The value property
     */
    value?: boolean | number | string | null;
}
export type RelevanceLogicExpression_operator = (typeof RelevanceLogicExpression_operatorObject)[keyof typeof RelevanceLogicExpression_operatorObject];
export type RelevanceLogicExpression_value = boolean | number | string;
 ...
 */
// @ts-ignore
export function serializeFormItemDefinition(writer: SerializationWriter, formItemDefinition: Partial<FormItemField | FormItemGroup | FormItemNote | FormItemSeparator> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
...
export function serializeFormItemGroup(writer: SerializationWriter, formItemGroup: Partial<FormItemGroup> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfObjectValues<FormItemField | FormItemGroup | FormItemNote | FormItemSeparator>("children", formItemGroup.children, serializeFormItemDefinition);
...
export function serializeFormVersionDefinition(writer: SerializationWriter, formVersionDefinition: Partial<FormVersionDefinition> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeCollectionOfObjectValues<FormItemField | FormItemGroup | FormItemNote | FormItemSeparator>("items", formVersionDefinition.items, serializeFormItemDefinition);
...
export function serializeRelevanceLogicExpression(writer: SerializationWriter, relevanceLogicExpression: Partial<RelevanceLogicExpression> | undefined | null = {}, isSerializingDerivedType: boolean = false) : void {
    ...
    writer.writeEnumValue<RelevanceLogicExpression_operator>("operator", relevanceLogicExpression.operator);
    if ( typeof relevanceLogicExpression.value === "boolean") {
        writer.writeBooleanValue("value", relevanceLogicExpression.value as boolean);
    }
    else if ( typeof relevanceLogicExpression.value === "number") {
        writer.writeNumberValue("value", relevanceLogicExpression.value as number);
    }
    else if ( typeof relevanceLogicExpression.value === "string") {
        writer.writeStringValue("value", relevanceLogicExpression.value as string);
    }
}
/**
 * Serializes information the current object
 ...
 */
// @ts-ignore
export function serializeRelevanceLogicExpression_value(writer: SerializationWriter, key: string, relevanceLogicExpression_value: Parsable | RelevanceLogicExpression_value | undefined, isSerializingDerivedType: boolean = false) : void {
    if (relevanceLogicExpression_value === undefined || relevanceLogicExpression_value === null) return;
    if (typeof relevanceLogicExpression_value === "boolean" ) {
        writer.writeBooleanValue(undefined, relevanceLogicExpression_value as boolean);
    }
    else if (typeof relevanceLogicExpression_value === "number" ) {
        writer.writeNumberValue(undefined, relevanceLogicExpression_value as number);
    }
    else if (typeof relevanceLogicExpression_value === "string" ) {
        writer.writeStringValue(undefined, relevanceLogicExpression_value as string);
    }
}
/**
 * Serializes information the current object
...
export const RelevanceLogicExpression_operatorObject = {
    InEscaped: "in",
    Eq: "eq",
    Ne: "ne",
    Gt: "gt",
