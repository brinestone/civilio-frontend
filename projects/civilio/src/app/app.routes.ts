...
export const routes: Routes = [
	...
	},
	{
		...
		providers: [provideFormsSdk(), provideDatasetSdk()],
	...
	},
	{
		path: "schemas",
		loadComponent: () =>
			import("./pages/forms/designer/list/form-schemas-list.page").then(
				(m) => m.FormSchemasPage,
			),
		canActivate: [dbConfigValidGuardFn, apiConfigValidGuardFn],
	...
	},
	{
		...
		loadChildren: () =>
			import("./settings.routes").then((m) => m.settingsRoutes),
	},
