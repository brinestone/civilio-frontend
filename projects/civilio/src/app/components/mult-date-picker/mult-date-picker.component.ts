...
export class MultiDatePicker implements FormValueControl<
...
> {
	...
	public readonly buttonId = input<string>(`multi-date-picker-${++nextId}`, {
		alias: "id",
	});
	...
	public readonly autoCloseOnSelection = input<boolean, BooleanInput>(false, {
		transform: booleanAttribute,
	});
