...
export class FormFieldConfig extends BaseFieldConfig<FieldItemConfig> {
	...
	protected readonly fieldMetaConfigComponentsMap = {
		...
		"single-select": import("../select-meta/single-select-meta/single-select-meta").then(
			(m) => m.SingleSelectMeta,
		),
		"multi-select": import("../select-meta/multi-select-meta/multi-select-meta").then(
			(m) => m.MultiSelectMeta,
		),
