...
export const settingsRoutes: Routes = [
	{
		...
		loadComponent: () =>
			import("./pages/settings/general-settings/general-settings.page").then(
	...
	},
	{
		...
		loadComponent: () =>
			import("./pages/settings/dataset-editor/dataset-editor.page").then(
				(m) => m.DatasetEditorPage,
			),
	},
	{
		...
		loadComponent: () =>
			import("./pages/settings/field-mapping-settings/field-mapping-settings.page").then(
				(m) => m.FieldMappingSettingsPage,
			),
		children: [
			{
				...
				loadComponent: () =>
					import("./pages/settings/field-mapping-settings/mapping-page/mapping.page").then(
						(m) => m.MappingPage,
					),
			},
			{
	...
	},
	{
		...
		loadComponent: () =>
			import("./pages/settings/advanced-settings/advanced-settings.page").then(
				(m) => m.AdvancedSettingsPage,
			),
	},
	{
		path: "about",
