...
const relevanceMap = {
	centerIsNotPrimaryOrSecondary: {
		...
		predicate: RelevancePredicateSchema.implement(
			(deps) =>
				!deps["csc.form.sections.identification.fields.category"] ||
				["3", "4"].includes(
					deps["csc.form.sections.identification.fields.category"] as string,
				),
		),
	...
	dataIndexed: {
		...
		predicate: RelevancePredicateSchema.implement((deps) =>
			["1", "2"].includes(
				deps["csc.form.sections.record_indexing.fields.data_indexed"] as string,
			),
		),
	} as RelevanceDefinition,
	documentsScanned: {
		...
		predicate: RelevancePredicateSchema.implement(
			(deps) =>
				deps["csc.form.sections.record_indexing.fields.records_scanned"] == 1,
		),
	} as RelevanceDefinition,
	centerIsFunctional: {
		...
		predicate: RelevancePredicateSchema.implement(
			(deps) =>
				deps["csc.form.sections.identification.fields.is_functional"] === true,
		),
	} as RelevanceDefinition,
	centerHasCsSoftware: {
		...
		predicate: RelevancePredicateSchema.implement(
			(deps) =>
				deps["csc.form.sections.digitization.fields.has_cs_software"] === true,
		),
	} as RelevanceDefinition,
};
	...
	sections: [
				...
				},
				{
					...
					relevance: {
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								deps[
									"csc.form.sections.respondent.fields.knows_creation_date"
								] === true
							);
						}),
						dependencies: [
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						...
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								deps["csc.form.sections.identification.fields.category"] === "3"
							);
						}),
					},
				},
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.identification.fields.non_function_reason",
						],
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								intersection(
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.identification.fields.is_officer_appointed",
						],
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								deps[
		...
		// #region Accessibility
		{
			fields: [
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.accessibility.sections.general.fields.serving_roads",
						],
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								deps[
					...
					fields: [
						{
							...
							type: "table",
							identifierColumn:
								"csc.form.sections.accessibility.sections.villages.fields.index",
							columns: {
								index: {
									visible: false,
		...
		// #region Infrastructure
		{
			...
			relevance: {
				...
				predicate: RelevancePredicateSchema.implement((deps) => {
					return (
						deps["csc.form.sections.identification.fields.is_functional"] ===
						true
					);
				}),
			},
			fields: [
				...
				},
				{
					...
					relevance: {
						...
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								deps["csc.form.sections.infra.fields.eneo_connection"] == true,
						),
					},
				},
				{
				...
				},
				{
					...
					relevance: {
						...
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								deps["csc.form.sections.infra.fields.has_backup_power"] === true
							);
						}),
					},
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.infra.fields.backup_power_sources",
						],
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								intersection(
				...
				},
				{
					...
					relevance: {
						...
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								deps["csc.form.sections.infra.fields.toilets_available"] ===
								true
							);
						}),
					},
					...
					relevance: {
						...
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								intersection(
									deps[
										"csc.form.sections.infra.fields.network_type"
									] as string[],
									["4"],
								).length > 0
							);
				...
				},
				{
					...
					relevance: {
						...
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								deps["csc.form.sections.infra.fields.has_internet"] === true,
						),
					},
				},
				{
					...
					relevance: {
						...
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								intersection(
									deps[
										"csc.form.sections.infra.fields.internet_type"
									] as string[],
									["4"],
								).length > 0
							);
		...
		// #region Areas
		{
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.areas.sections.general.fields.dedicated_cs_rooms",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								deps[
					...
					fields: [
						{
							...
							identifierColumn:
								"csc.form.sections.areas.sections.rooms.fields.index",
							columns: {
								index: {
									editable: false,
									visible: false,
		...
		// #region Digitization
		{
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.digitization.fields.external_service_from_cr",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								deps[
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.digitization.fields.cs_software_license_sponsor",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								intersection(
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.digitization.fields.is_software_functioning",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								deps[
		...
		// #region Record Indexing
		{
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.record_indexing.fields.is_data_used_by_csc",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								deps[
		...
		// #region Record Procurement
		{
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.record_procurement.fields.records_provider",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								intersection(
		...
		// #region Archiving Function
		{
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.archiving_function.sections.general.fields.register_archiving_type",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								intersection(
				...
				},
				{
					...
					relevance: {
						dependencies: [
							"csc.form.sections.archiving_function.sections.general.fields.is_vandalized",
						],
						predicate: RelevancePredicateSchema.implement(
							(deps) =>
								deps[
					...
					fields: [
						{
							key: {
								value:
									"csc.form.sections.archiving_function.sections.archive_stats.fields.list",
								titleArgs: {
							...
							relevance: relevanceMap.centerIsPrimaryOrSecondary,
							identifierColumn:
								"csc.form.sections.archiving_function.sections.archive_stats.fields.index",
							columns: {
								index: {
									visible: false,
					...
					fields: [
						{
							...
							relevance: relevanceMap.centerIsFunctional,
							identifierKey:
								"csc.form.sections.employees.sections.officers.fields.index",
							fields: [
								{
									visible: false,
									editable: false,
								...
								},
								{
									...
									relevance: {
										dependencies: [
											"csc.form.sections.employees.sections.officers.fields.position",
										],
										predicate: RelevancePredicateSchema.implement((deps) => {
											return (
												deps[
								...
								},
								{
									...
									relevance: {
										dependencies: [
											"csc.form.sections.employees.sections.officers.fields.prof_status",
										],
										predicate: RelevancePredicateSchema.implement((deps) => {
											return (
												deps[
								...
								},
								{
									key: {
										value:
											"csc.form.sections.employees.sections.officers.fields.monthly_salary",
										titleArgs: {
