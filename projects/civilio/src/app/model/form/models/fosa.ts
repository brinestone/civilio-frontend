				...
				},
				{
					...
					relevance: {
						predicate: RelevancePredicateSchema.implement((deps) => {
							const v =
								deps[
									"fosa.form.sections.respondent.fields.knows_creation_date"
								];
							return v === true;
						}),
						dependencies: [
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						predicate: RelevancePredicateSchema.implement((deps) => {
							return (
								deps["fosa.form.sections.identification.fields.category"] ===
								"10"
							);
						}),
				...
				},
				{
					...
					relevance: {
						predicate: RelevancePredicateSchema.implement((deps) => {
							const v =
								deps[
									"fosa.form.sections.identification.fields.knows_gps_coords"
								];
							return v === true;
						}),
						dependencies: [
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						predicate: RelevancePredicateSchema.implement((deps) => {
							const v =
								deps["fosa.form.sections.reg_cs_events.fields.dhis2_usage"];
							return v === true;
						}),
						dependencies: [
							"fosa.form.sections.reg_cs_events.fields.dhis2_usage",
						],
					},
				},
				{
			...
			fields: [
				...
				},
				{
					...
					relevance: {
						predicate: RelevancePredicateSchema.implement((deps) => {
							const v =
								deps["fosa.form.sections.infra.fields.backup_power_available"];
							return v === true;
						}),
						dependencies: [
							"fosa.form.sections.infra.fields.backup_power_available",
						],
					},
				},
				{
				...
				},
				{
					...
					relevance: {
						predicate: RelevancePredicateSchema.implement((deps) => {
							const v =
								deps["fosa.form.sections.infra.fields.water_source_available"];
							return v === true;
						}),
						dependencies: [
							"fosa.form.sections.infra.fields.water_source_available",
						],
					},
					required: true,
				},
		...
		},
		{
			...
			fields: [
				...
				},
				{
					...
					type: "table",
					identifierColumn:
						"fosa.form.sections.staff.sections.employees.fields.index",
					columns: {
						index: {
							visible: false,
