...
import fr.civipol.civilio.forms.controls.CHEFFERIEPersonnelInfoControl;
...
public class CHEFFERIEPersonnelInfoField extends DataField<ListProperty<PersonnelInfo>, List<PersonnelInfo>, CHEFFERIEPersonnelInfoField> {
    ...
    private final StringProperty addRowLabel, removeSelectionLabel, nameColumnLabel, roleColumnLabel, genderColumnLabel, phoneColumnLabel, ageColumnLabel,
            hasCivilStatusTrainingColumnLabel, educationLevelColumnLabel, computerKnowledgeLevelColumnLabel;

    protected CHEFFERIEPersonnelInfoField(ListProperty<PersonnelInfo> valueProperty, ListProperty<PersonnelInfo> persistentValueProperty) {
    ...
    public static Field<CHEFFERIEPersonnelInfoField> personnelInfoField(Collection<PersonnelInfo> items) {
        return new FOSAPersonnelInfoField(new SimpleListProperty<>(FXCollections.observableArrayList(items)), new SimpleListProperty<>(FXCollections.observableArrayList()))
                .render(CHEFFERIEPersonnelInfoControl::new);
    }
}
